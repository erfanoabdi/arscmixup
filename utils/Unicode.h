...
// Standard string functions on uint16_t strings.
...
// Standard string functions on uint32_t strings.
 ...
 * If returned value is positive, it is able to be converted to uint32_t, which
 ...
 */
size_t
decodeLength8(const uint8_t** str);
